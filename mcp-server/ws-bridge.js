#!/usr/bin/env node
/**
 * WebSocket bridge for Sapientia MCP tools.
 *
 * Exposes vault operations over WebSocket so the Sapientia app frontend
 ...
 * is unavailable (e.g. another Sapientia instance owns it).
 */
