...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::read_paper_metadata,
            commands::extract_paper_metadata,
            commands::refresh_paper_metadata,
            commands::apply_paper_metadata_candidate,
            commands::save_paper_metadata,
            commands::list_paper_catalog,
            commands::search_paper_catalog,
            commands::find_paper_duplicates,
            commands::refresh_paper_catalog,
            commands::mark_paper_duplicate_decision,
            commands::read_paper_comments,
