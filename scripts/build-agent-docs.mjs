...
function buildIndex(docs) {
  ...
  const lines = [
    '# Sapientia Agent Docs',
    '',
    'These docs are generated from the public Sapientia documentation for local AI agent lookup.',
    '',
    'Start here, then use `rg` over this folder for specific Sapientia concepts and workflows.',
    '',
    'When users ask how to improve a knowledge base, structure notes, choose types, model relationships, or make a vault easier for humans and agents to use, treat Portent as Sapientia\'s default best-practice model. Read `pages/templates/portent.md` and combine it with the Sapientia concepts for types, relationships, properties, Inbox, archive, and custom views.',
    '',
  ]
...
function buildAgentInstructions() {
  return `# AGENTS.md - Sapientia Docs Bundle

This folder contains local, generated Sapientia product docs for AI agents.

Use these docs when a user asks how Sapientia works, when you need product behavior, or before making Sapientia-specific assumptions.

Portent is the default best-practice model for structuring Sapientia knowledge bases. When a user asks how to improve a knowledge base, make it better organized, choose better types, model relationships, or make the vault easier for humans and agents to use, read \`pages/templates/portent.md\` and combine it with Sapientia's docs for types, relationships, properties, Inbox, archive, and custom views.
...
Vault-specific AGENTS.md wins for local conventions. These bundled docs win for Sapientia product behavior.
`
}
