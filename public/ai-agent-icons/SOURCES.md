...
- GitHub Copilot: Sapientia-created monogram using the GitHub Copilot brand name from https://docs.github.com/en/copilot
...
- Hermes Agent: Sapientia-created monogram using the Hermes Agent brand name from https://hermes-agent.nousresearch.com/docs/getting-started/quickstart
