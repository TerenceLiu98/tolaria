    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[520px]" data-testid="clone-vault-modal">
        <DialogHeader>
          ...
          <DialogDescription>
            Clone any remote repository into a local vault folder. Sapientia uses your existing system git
        ...
        <form className="flex flex-col gap-4 py-2" onSubmit={handleSubmit} data-testid="clone-vault-form" aria-busy={isCloning}>
          ...
          <p className="text-xs text-muted-foreground">
            {isCloning
              ? 'Cloning repository… Sapientia will open the vault when git finishes.'
