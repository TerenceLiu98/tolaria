import { Article, ArrowsClockwise as RefreshCw, Cube, GitBranch, ListChecks, MagnifyingGlass, Palette, Robot as Bot, ShieldCheck, type IconProps } from '@phosphor-icons/react'
...
export function SettingsBodyNav({ t }: SettingsBodyNavProps) {
  const items: SettingsNavItem[] = [
    ...
    { id: SETTINGS_SECTION_IDS.parser, label: t('settings.paperParser.title'), Icon: MagnifyingGlass },
